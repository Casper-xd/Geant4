...
G4VPhysicalVolume* DetectorConstruction::Construct() {
    ...
    // Материал сцинтиллятора с добавками
    ...
    // == Цилиндрический бак из нержавеющей стали == 
    ...
    // == Сфера из ПММА == 
    G4double sphereRadius = 0.62035 * m + 10 * mm;  // Радиус, чтобы объем был примерно 1 м³
